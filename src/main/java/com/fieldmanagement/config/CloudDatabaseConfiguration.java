package com.fieldmanagement.config;
...
@Configuration
@EnableMongoRepositories("com.fieldmanagement.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.fieldmanagement.config.dbmigrations");
